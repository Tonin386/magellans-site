...
class Operation(models.Model):
    ...
    third_party = models.ForeignKey(Person, on_delete=models.DO_NOTHING, verbose_name='Tiers', related_name='operations')
...
class Expense(models.Model):
    ...
    proof = models.FileField(verbose_name="Justificatif de paiement", null=True, blank=True, upload_to="img/proofs/")
